...
public class ConnectionImplCreateInstrumentation extends AbstractMysqlInstrumentation {
    ...
    private static final String GET_INSTANCE_NEW_INTERCEPTOR = "org.apache.skywalking.apm.cyborg.flow.plugin.jdbc.mysql.v6.ConnectionCreateNewInterceptor";

    private static final String GET_INSTANCE_OLD_INTERCEPTOR = "org.apache.skywalking.apm.cyborg.flow.plugin.jdbc.mysql.v6.ConnectionCreateOldInterceptor";
